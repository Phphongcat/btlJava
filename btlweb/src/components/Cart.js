...
import StripeContiner from "./StripeContainer";
...
const Cart = () => {
    ...
    return <>
        ...
        </> : <><Button variant="info" onClick={pay} className="mt-2 mb-2">Thanh toán tiền mặt</Button>
            {showItem ? <StripeContiner /> : <Button onClick={() => setShowItem(true)}>Thanh toán online</Button>}</>}
    </>
}
